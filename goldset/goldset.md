...
## From close related surveys: 21 References
...
## From academic IaC expertise

- [22] D. Sokolowski, D. Spielmann, G. Salvaneschi, “Automated infrastructure as code program testing”. IEEE Transactions on Software Engineering. **cited by 30**
- [23] R. Opdebeeck, A. Zerouali, C. De Roover, “Smelly variables in Ansible infrastructure code: Detection, prevalence, and lifetime”. Proceedings of the 19th International Conference on Mining Software Repositories. pp. 61-72. **cited by 44**
- [24] Weili Fu, Roly Perera, Paul Anderson, and James Cheney. “MuPuppet: A declarative subset of the puppet configuration language”. 74:1–27, 2017. doi: 10.4230/LIPICS.ECOOP.2017.12. **cited by 14**


# Evaluating the SLR with the gold set

- SLR final:            **16/24** ; missing [8,12,13,14,18,19,20,24] ; work cited with other reference: [9,11]
- SLR queries:          **16/24**; missing [8,12,13,14,18,19,20,24] 
- Query (1st version):  **/24**
- Query (2nd version):  **/24**
- Query (3rd version):  **/24**
